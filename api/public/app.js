...
function showResultsModal(data) {
    ...
    if (data.image_path) {
        document.getElementById('res-image-preview').src = getImageUrl(data.image_path);
                        ...
                        <div>
                            ...
                            <div style="margin-top: 1rem;">
                                ...
                                <div class="complaint-img-container">
                                    <img src="${getImageUrl(ticket.image_path)}" alt="Situation Photo" onclick="window.open('${getImageUrl(ticket.image_path)}', '_blank')">
                                </div>
                                ${ticket.image_tags ? `
                    ...
                    <div class="drawer-content">
                        <div>
                            ...
                            <div style="margin-top: 1rem;">
                                <h4 class="drawer-panel-title">Attached Photo</h4>
                                <div class="complaint-img-container">
                                    <img src="${getImageUrl(ticket.image_path)}" alt="Attached Photo" onclick="window.open('${getImageUrl(ticket.image_path)}', '_blank')">
                                </div>
                                ${ticket.image_tags ? `
                                <div style="margin-top: 0.5rem;">
                                    <span class="badge image-tags-badge">
